...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_cams/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_cams/timings"
save_path3="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_cams/truths"
