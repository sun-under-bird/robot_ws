...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_kaist/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_kaist/timings"
bag_path="${OPENVINS_DATASET_DIR:-${HOME}/datasets}/kaist/"
ov_ver="2.7"
