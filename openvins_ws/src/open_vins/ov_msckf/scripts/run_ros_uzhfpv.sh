...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_uzhfpv/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_uzhfpv/timings"
bag_path="${OPENVINS_DATASET_DIR:-${HOME}/datasets}/uzhfpv/"
ov_ver="2.7"
