...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_tumvi/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_tumvi/timings"
bag_path="${OPENVINS_DATASET_DIR:-${HOME}/datasets}/tum_vi/"
ov_ver="2.7"
