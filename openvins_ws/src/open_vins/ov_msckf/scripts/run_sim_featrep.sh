...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_featrep/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_featrep/timings"
save_path3="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/sim_featrep/truths"
