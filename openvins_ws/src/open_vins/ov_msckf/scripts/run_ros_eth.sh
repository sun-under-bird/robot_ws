...
save_path1="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_euroc/algorithms"
save_path2="${OPENVINS_RESULTS_DIR:-${HOME}/openvins_results}/exp_euroc/timings"
bag_path="${OPENVINS_DATASET_DIR:-${HOME}/datasets}/euroc_mav/"
ov_ver="2.7"
