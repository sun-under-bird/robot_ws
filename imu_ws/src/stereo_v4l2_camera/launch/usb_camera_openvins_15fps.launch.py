...
def generate_launch_description():
    """以 YUYV 15 FPS 启动面向 OpenVINS 的新 USB 双目相机。"""
    ...
    arguments = [
        ...
        # 以下默认值来自新相机当前实际使用的 V4L2 控制值。
        DeclareLaunchArgument('brightness', default_value='20'),
        DeclareLaunchArgument('contrast', default_value='5'),
        ...
        DeclareLaunchArgument('gain', default_value='150'),
        ...
        # V4L2 绝对曝光单位为 100 微秒，150 对应 15 毫秒。
        DeclareLaunchArgument('exposure_time_absolute', default_value='9990'),
